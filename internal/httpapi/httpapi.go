...
func (s *Server) resolve(w http.ResponseWriter, r *http.Request) {
	...
	body, err := decodeResolveRequest(r)
	if err != nil {
		writeErr(w, err)
		return
	}
...
func decodeResolveRequest(r *http.Request) (resolveRequest, error) {
	...
	if err := decodeJSON(r, &body); err != nil {
		return resolveRequest{}, errcode.New(errcode.BadRequest, "invalid JSON")
	}
	if body.Artifact == "" {
		return resolveRequest{}, errcode.New(errcode.BadRequest, "artifact required")
	}
	return body, nil
}

func writeResolutionResult(w http.ResponseWriter, out *service.ResolutionOutput) {
	result := service.ResolutionOutput{
